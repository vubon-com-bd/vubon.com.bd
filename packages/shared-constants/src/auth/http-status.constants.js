 ...
 */
export const isInformational = (code) => {
 ...
 */
export const isRedirection = (code) => {
 ...
 */
export const getStatusCategory = (code) => {
    if (isInformational(code))
        return HTTP_STATUS_CATEGORIES.INFORMATIONAL;
    if (isSuccess(code))
        return HTTP_STATUS_CATEGORIES.SUCCESS;
    if (isRedirection(code))
        return HTTP_STATUS_CATEGORIES.REDIRECTION;
    if (isClientError(code))
        return HTTP_STATUS_CATEGORIES.CLIENT_ERROR;
    if (isServerError(code))
        return HTTP_STATUS_CATEGORIES.SERVER_ERROR;
    return null;
};
/**
 ...
 */
export const createHttpStatus = (code) => {
