...
export const IP_SECURITY = {
   ...
   */
  BLACKLISTED_IPS: [] as string[],

  /**
   * IP geolocation block list
   */
  GEOLOCATION_BLOCK_LIST: [] as string[],
...
export const SECURITY_HEADERS = {
   ...
   */
  PERMISSIONS_POLICY:
    'geolocation=(), microphone=(), camera=(), payment=(), usb=(), battery=(), autoplay=()',
 ...
 */
export const SECURITY_LEVEL_REQUIREMENTS: Record<
  SecurityLevel,
  {
    requires2FA: boolean;
 ...
 */
export const DEFAULT_SECURITY_CONFIG: Omit<SecurityConfig, 'enabled' | 'level'> = {
...
export type SecurityErrorMessage =
  (typeof SECURITY_ERROR_MESSAGES)[keyof typeof SECURITY_ERROR_MESSAGES];
...
export type SecurityWarningMessage =
  (typeof SECURITY_WARNING_MESSAGES)[keyof typeof SECURITY_WARNING_MESSAGES];
...
export type SecurityNotification =
  (typeof SECURITY_NOTIFICATIONS)[keyof typeof SECURITY_NOTIFICATIONS];
