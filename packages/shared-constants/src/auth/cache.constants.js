 ...
 */
export const CACHE_INVALIDATION_MAPPING = {
 ...
 */
export const buildCacheKey = (prefix, identifier) => {
    return `${prefix}${identifier}`;
};
/**
 * Helper function to build cache key with namespace
 */
export const buildCacheKeyWithNamespace = (prefix, namespace, identifier) => {
    return `${prefix}${namespace}:${identifier}`;
};
/**
 * Helper function to get adaptive TTL based on network type
 */
export const getAdaptiveTTL = (baseTTL, networkType) => {
