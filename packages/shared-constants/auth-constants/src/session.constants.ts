...
// ============================================================
export const SESSION_IDLE_TIMEOUT = Object.freeze({
...
// ============================================================
export const SESSION_METADATA = Object.freeze({
  // Core metadata
...
// ============================================================
export const MAX_CONCURRENT_SESSIONS = Object.freeze({
  // Default limits
  DEFAULT: 5,
  PREMIUM: 10,
  ENTERPRISE: 20,
...
// ============================================================
export const SESSION_LOCATION = Object.freeze({
...
// ============================================================
export const SESSION_CLEANUP = Object.freeze({
  ...
  RETENTION_DAYS: {
    ACTIVE: 7,        // Keep active session logs for 7 days
    EXPIRED: 30,      // Keep expired sessions for 30 days
    REVOKED: 90,      // Keep revoked sessions for 90 days (audit)
  },
...
// ============================================================
export const SESSION_EXTENSION = Object.freeze({
...
// ============================================================
export const FAMILY_SESSION_SHARING = Object.freeze({
  ENABLED: true,
...
// ============================================================
export const PUBLIC_DEVICE_SESSION = Object.freeze({
  ENABLED: true,
