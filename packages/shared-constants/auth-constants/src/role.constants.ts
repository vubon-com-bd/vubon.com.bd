 ...
 * 
 * @module shared-constants/auth-constants/role.constants
 * 
 * RULES:
...
export const ROLES = Object.freeze({
  ...
  VENDOR_MANAGER: 'vendor_manager',    // Manage multiple vendors
  DELIVERY_AGENT: 'delivery_agent',     // Last-mile delivery
  DELIVERY_MANAGER: 'delivery_manager', // Manage delivery operations
  ...
  CUSTOMER: 'customer',
  GUEST: 'guest',
  PREMIUM_CUSTOMER: 'premium_customer', // Loyalty program
  
  // ========== Bangladesh Specific ==========
  DISTRICT_MANAGER: 'district_manager', // District level operations
  UPZILA_AGENT: 'upzila_agent',         // Local level agent
  MFS_AGENT: 'mfs_agent',               // bKash/Nagad/Rocket agent
} as const);
...
export const ROLE_INHERITANCE = Object.freeze({
  [ROLES.SUPER_ADMIN]: null,                    // No parent (top level)
...
export const ROLE_METADATA = Object.freeze({
  ...
  [ROLES.DISTRICT_MANAGER]: {
    ...
    cannotBeDeleted: false,
    cannotBeAssignedAutomatically: false,
    maxAssignees: 64,        // One per district
    requiresMfa: true,
    auditLogging: 'standard',
  },
...
export const ROLE_COLORS = Object.freeze({
  ...
  [ROLES.ADMIN]: '#EA580C',            // Orange
  [ROLES.SYSTEM_MONITOR]: '#8B5CF6',   // Purple
  [ROLES.AUDITOR]: '#6B7280',          // Gray
  
  [ROLES.CONTENT_MANAGER]: '#10B981',  // Emerald
  [ROLES.MARKETING_MANAGER]: '#F59E0B', // Amber
  [ROLES.ANALYST]: '#3B82F6',          // Blue
  
  [ROLES.SUPPORT_SUPERVISOR]: '#06B6D4', // Cyan
  [ROLES.SUPPORT_AGENT]: '#14B8A6',     // Teal
  
  [ROLES.VENDOR_MANAGER]: '#8B5CF6',    // Purple
  [ROLES.VENDOR]: '#A855F7',            // Violet
  [ROLES.SHOP_MANAGER]: '#D946EF',      // Fuchsia
  [ROLES.SHOP_STAFF]: '#EC4899',        // Pink
  
  [ROLES.DELIVERY_MANAGER]: '#F97316',  // Orange
  [ROLES.DELIVERY_AGENT]: '#FBBF24',    // Yellow
  
  [ROLES.PREMIUM_CUSTOMER]: '#F59E0B',  // Gold
  [ROLES.CUSTOMER]: '#10B981',          // Green
  [ROLES.GUEST]: '#9CA3AF',             // Light Gray
  
  [ROLES.DISTRICT_MANAGER]: '#0891B2',  // Dark Cyan
  [ROLES.UPZILA_AGENT]: '#0D9488',      // Dark Teal
  [ROLES.MFS_AGENT]: '#6366F1',         // Indigo
} as const);

// ============================================================
// Role Badge Variants (For UI components)
// ============================================================
export const ROLE_BADGE_VARIANTS = Object.freeze({
...
// ============================================================
export const ROLE_ASSIGNMENT_LIMITS = Object.freeze({
