...
export const KnowledgeBaseCategorySchema: z.ZodType<unknown> = BaseSchema.extend({
  ...
  parent: z.lazy(() => KnowledgeBaseCategorySchema).optional(),
  children: z.array(z.lazy(() => KnowledgeBaseCategorySchema)).default([]),
