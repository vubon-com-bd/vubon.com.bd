...
export interface EntityDetailProps extends Omit<HTMLAttributes<HTMLDivElement>, 'title'> {
...
export const EntityDetail = forwardRef<HTMLDivElement, EntityDetailProps>(function EntityDetail(
