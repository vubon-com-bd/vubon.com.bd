...
export const AddressInput = forwardRef<HTMLDivElement, AddressInputProps>(
  function AddressInput({ value, onChange, disabled, className }, ref) {
    ...
    return (
      <div ref={ref} className={cn('grid grid-cols-1 gap-3 md:grid-cols-2', className)}>
        <div className="flex flex-col gap-1 md:col-span-2">
          <Label htmlFor="addr-line1" required>Address line 1</Label>
          <Input
            id="addr-line1"
            value={value.line1}
            disabled={disabled}
        ...
        <div className="flex flex-col gap-1">
          <Label htmlFor="addr-country" required>Country</Label>
          <Input
            id="addr-country"
            value={value.country}
            disabled={disabled}
