/**
 * Deal Analytics Calculator
 * ডিল অ্যানালিটিক্স ক্যালকুলেটর
 */

import type { DealAnalytics } from '@vubon/shared-types';

export interface DealAnalyticsCalculation {
  views: number;
  uniqueViews: number;
  clicks: number;
  addToCarts: number;
...
export const calculateDealAnalytics = (analytics: DealAnalytics): DealAnalyticsCalculation => {
...
export const calculateDealAnalyticsTrend = (
  current: DealAnalyticsCalculation,
  previous: DealAnalyticsCalculation
): {
  viewsChange: number;
