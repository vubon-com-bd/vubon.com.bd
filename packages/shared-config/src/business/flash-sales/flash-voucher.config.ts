 ...
 * ফ্ল্যাশ ভাউচার কনফিগারেশন
 */

import { FLASH_SALE_VOUCHER } from '@vubon/shared-constants';

export interface FlashVoucherConfig {
  enabled: boolean;
  maxDiscount: number;
...
export const flashVoucherConfig: FlashVoucherConfig = {
  enabled: true,
  maxDiscount: 30,
  minOrderAmount: 200,
  maxUsage: 50,
...
export type FlashVoucherConfigType = typeof flashVoucherConfig;
