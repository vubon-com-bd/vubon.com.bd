/**
 * SurveyRepository — Repository interface
...
export interface SurveyRepository
  extends BaseRepository<SurveyEntity, SurveyIdVO> {
  findActive(): Promise<readonly SurveyEntity[]>;
  findByStatus(status: SurveyStatusVO): Promise<readonly SurveyEntity[]>;
  findByType(type: SurveyTypeVO): Promise<readonly SurveyEntity[]>;
  findSatisfactionSurveys(): Promise<readonly SurveyEntity[]>;
}
