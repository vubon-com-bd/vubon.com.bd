...
export class AddItemHandler
  extends BaseCommandHandler<AddItemCommand, CartResponseDTO>
  implements ICommandHandler<AddItemCommand>
{
  readonly commandType = 'cart.item.add';
  ...
  async execute(command: AddItemCommand): Promise<CartResponseDTO> {
