...
import type { User, Session } from '../../../domain/entities';
...
export interface IAuthService {
   ...
   * @returns User entity
   */
  getCurrentUser(userId: string, includeSensitive?: boolean): Promise<User>;
   ...
   */
  getUserSessions(userId: string, options?: PaginationOptions): Promise<PaginatedResult<Session>>;
  ...
  changePassword(
    ...
    ServiceResult<{ passwordChanged: boolean; sessionsRevoked?: number; newSessionId?: string }>
  >;
