...
import { UserRole, UserStatus, UserTier } from '@vubon/shared-constants';
...
export interface UserRepository extends BaseRepository<User> {
   ...
   * @returns Paginated users
   */
  findByTier(tier: UserTier, options: PaginationOptions): Promise<PaginatedResult<User>>;
   ...
   * @returns Paginated users
   */
  searchUsers(searchTerm: string, options: PaginationOptions): Promise<PaginatedResult<User>>;
   ...
   * @returns Paginated users
   */
  findByFilters(filters: UserFilters, options: PaginationOptions): Promise<PaginatedResult<User>>;
   ...
   * @returns Paginated users
   */
  findByDistrict(district: string, options: PaginationOptions): Promise<PaginatedResult<User>>;
   ...
   * @returns Paginated users
   */
  findRecentlyActive(days: number, options: PaginationOptions): Promise<PaginatedResult<User>>;
   ...
   */
  bulkActivate(userIds: string[], onProgress?: BulkProgressCallback): Promise<BulkOperationResult>;
   ...
   * @returns Bulk operation result
   */
  bulkUnlock(userIds: string[], onProgress?: BulkProgressCallback): Promise<BulkOperationResult>;
   ...
   */
  getUserDistributionByDistrict(): Promise<
    Array<{ district: string; count: number; percentage: number }>
  >;
   ...
   */
  getUserDistributionByUpazila(
    district?: string,
  ): Promise<Array<{ upazila: string; district: string; count: number; percentage: number }>>;
   ...
   */
  exportForAudit(filters?: UserFilters, options?: PaginationOptions): Promise<User[]>;
...
export interface AdvancedUserRepository extends UserRepository {
  ...
  findSimilarUsers(
    userId: string,
    limit?: number,
  ): Promise<Array<{ userId: string; similarity: number; commonTraits: string[] }>>;
   ...
   */
  refreshEngagementScores(userIds?: string[], onProgress?: BulkProgressCallback): Promise<number>;
}
