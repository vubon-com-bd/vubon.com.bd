...
export class PauseSubscriptionHandler
  extends BaseCommandHandler<PauseSubscriptionCommand, SubscriptionResponseDTO>
  implements ICommandHandler<PauseSubscriptionCommand>
{
  readonly commandType = 'subscription.pause';
  ...
  async execute(command: PauseSubscriptionCommand): Promise<SubscriptionResponseDTO> {
